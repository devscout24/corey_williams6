...
Route::middleware('auth:employee')->group(function (): void {
    ...
    // Contacts module
    Route::middleware('check_module_permission:contacts')->group(function () {
        // column prefs
    ...
    // Messages module
    Route::middleware('check_module_permission:messages')->group(function () {
    ...
    // Employees module
    Route::middleware('check_module_permission:employees')->group(function () {
