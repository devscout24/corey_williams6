            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item">
                    ...
                    <div class="nav-submenu">
                        ...
                        <div class="nav-item"><a href="{{ Route::has('attributes.index') ? route('attributes.index') : '#' }}"
                                class="nav-link"><i class="bi bi-dot"></i> Attributes</a></div>
                        <div class="nav-item"><a href="{{ Route::has('price-rules.index') ? route('price-rules.index') : '#' }}"
                                class="nav-link"><i class="bi bi-dot"></i> Price Rules</a></div>
                    </div>
                </div>
