@php
    $defaultVisible = ['trans_date', 'name', 'trans_inventory', 'employee', 'trans_comment'];
...
<style>
    ...
    .table thead th { background: var(--gray-50); border-top: none; color: var(--gray-500); font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; padding: 16px; white-space: nowrap; }
    .table tbody td { padding: 16px; vertical-align: middle; color: var(--gray-700); border-bottom: 1px solid var(--gray-100); white-space: nowrap; }
    ...
    .column-picker .reset-link:hover { text-decoration: underline; }
    ...
    .column-picker .form-check:hover { background: var(--gray-50); }
    .column-picker .form-check-input { margin: 0; flex-shrink: 0; }
